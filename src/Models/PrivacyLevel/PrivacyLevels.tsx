...
export class PrivacyLevelInternalUse implements IPrivacyLevel{
 ...
 export class PrivacyLevelPublicShield implements IPrivacyLevel{
    private static _name: string = "public";    
     
    public get name(): string {
         return PrivacyLevelPublicShield._name;
     }
    
     
    public getIcon(): JSX.Element {
        return  <div style={{ display:'grid', gridTemplateRows: '1fr', gridAutoColumns:'1fr', alignItems:'center', justifyItems:'center'}}>
        <Icon style={{position:'relative', top:0, left: 0, fontSize: '0.6em',lineHeight:'0.6em', gridRow:'1/2', gridColumn:'1/2'}} iconName="CheckMark"/>

        <Icon style={{position:'relative', top:0,  gridRow:'1/2', gridColumn:'1/2'}} iconName="Shield"/>
 ...
 export class PrivacyLevelInternalUseShield implements IPrivacyLevel{
     private static _name: string = "internal use";    
      
     public get name(): string {
          return PrivacyLevelInternalUseShield._name;
      }
  ...
  export class PrivacyLevelSensitiveShield implements IPrivacyLevel{
     private static _name: string = "sensitive";    
      
     public get name(): string {
          return PrivacyLevelSensitiveShield._name;
      }
     
      
     public getIcon(): JSX.Element {
          return <Icon iconName="ShieldAlert"/>;
  ...
  export class PrivacyLevelHighlySensitiveShield implements IPrivacyLevel{
     private static _name: string = "highly sensitive";    
      
     public get name(): string {
          return PrivacyLevelHighlySensitiveShield._name;
      }
     
      
     public getIcon(): JSX.Element {
          return <Icon iconName="BlockedSite"/>;
